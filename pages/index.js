          ...
          <section className={styles.featuresOuter}>
            <div className={styles.featuresInner}>
              <Feature
                ...
                description="Cmdr stays out of the way, making it easy to write your own commands which plug-in to your systems. Help debug your game by triggering events or printing useful data."
              />
              <Feature
                title="Type-safe with intelligent autocomplete"
                description="Discover commands and possible values for arguments naturally with context-aware autocomplete. Arguments are strictly typed and validated for you, keeping typos at bay."
              />
              <Feature
                title="Powerful and extensible"
                description="Cmdr ships with optional built-in commands but you can register your own commands and types. Meta-commands like bind and alias make it possible to extend Cmdr even further."
              />
            </div>
          </section>
